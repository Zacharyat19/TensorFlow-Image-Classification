...
x_train /= 255
x_test /= 255
history = model.fit_generator(trainDatagen.flow(x_train, y_train, batch_size = 25), epochs = 200, steps_per_epoch = 1000, validation_data = testDatagen.flow(x_test, y_test, batch_size = 25), max_queue_size = 25, workers = 8, shuffle = True, callbacks = [checkpoint])
